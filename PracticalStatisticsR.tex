...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_table_}\DecValTok{0}\NormalTok{ <-}\StringTok{ }\KeywordTok{table}\NormalTok{(example_data}\OperatorTok{$}\NormalTok{x1, example_data}\OperatorTok{$}\NormalTok{x2)}
...
\includegraphics{PracticalStatisticsR_files/figure-latex/unnamed-chunk-36-1.pdf}
...
\includegraphics{PracticalStatisticsR_files/figure-latex/unnamed-chunk-40-1.pdf}
...
\includegraphics{PracticalStatisticsR_files/figure-latex/unnamed-chunk-43-1.pdf}
...
\includegraphics{PracticalStatisticsR_files/figure-latex/unnamed-chunk-50-1.pdf}
\# R Diagnostic Plots
...
\includegraphics{PracticalStatisticsR_files/figure-latex/unnamed-chunk-53-1.pdf}
\includegraphics{PracticalStatisticsR_files/figure-latex/unnamed-chunk-53-2.pdf}
\includegraphics{PracticalStatisticsR_files/figure-latex/unnamed-chunk-53-3.pdf}
\includegraphics{PracticalStatisticsR_files/figure-latex/unnamed-chunk-53-4.pdf}
...
\includegraphics{PracticalStatisticsR_files/figure-latex/unnamed-chunk-54-2.pdf}
...
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{X) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{poison =} \KeywordTok{factor}\NormalTok{(poison, }\DataTypeTok{ordered =} \OtherTok{TRUE}\NormalTok{))}
...
\includegraphics{PracticalStatisticsR_files/figure-latex/unnamed-chunk-57-1.pdf}
