...
```
*install psych package in console and use describe function from package for standard error.  This function also works on while dataframes.
```{r}
describe(Data$Fish, 
         type=2)
```
...
* independent two-sample t-test, where y is a numeric and x is a nibary factor
```{r message = FALSE}
x=rnorm(10)
y=rnorm(10)
